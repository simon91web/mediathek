---
description: Verwandte Stellen in allen anderen Beiträgen finden und eintragen
argument-hint: <slug>
---

Finde für den Beitrag `$1`, was in der übrigen Bibliothek damit zu tun hat.
...
1. `medien/$1/beitrag.md` und `medien/$1/transcript.json` — worum geht es
...
Nur in `medien/$1/beitrag.md`, im Block `bezuege`, mit `Edit`:
